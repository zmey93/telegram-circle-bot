...
### Исправлено
- Перехват ошибки `VOICE_MESSAGES_FORBIDDEN`: бот понятно предупреждает пользователя, если у него запрещено получение кружочков в настройках приватности Telegram.
